<template><div><h2 id="todo" tabindex="-1"><a class="header-anchor" href="#todo"><span>todo</span></a></h2>
<ul>
<li>
<p>rpc 和 Node.js 的关系</p>
</li>
<li>
<p><a href="https://mp.weixin.qq.com/s/uWeAsJ-P253je15A49uKIQ" target="_blank" rel="noopener noreferrer">《吊打面试官》系列 Node.js 全栈秒杀系统</a></p>
</li>
</ul>
...
<h3 id="前端同学为什么要学习后端-后端同学为什么要学习前端" tabindex="-1"><a class="header-anchor" href="#前端同学为什么要学习后端-后端同学为什么要学习前端"><span>前端同学为什么要学习后端/后端同学为什么要学习前端</span></a></h3>
<ul>
<li>
<p>了解前后端交互流程。</p>
</li>
<li>
<p>前端同学能够和后台开发的程序员更佳紧密地结合、更顺畅地沟通。</p>
</li>
<li>
<p>当网站的业务逻辑需要前置时，前端人员需要学习一些后台开发的技术，以完成相应的任务；；反过来也一样。</p>
</li>
<li>
<p>拓宽知识视野和技术栈，能够站在全局的角度审视整个项目。</p>
</li>
</ul>
<h3 id="前端同学为什么要学-node-js" tabindex="-1"><a class="header-anchor" href="#前端同学为什么要学-node-js"><span>前端同学为什么要学 Node.js</span></a></h3>
...
<h3 id="后端同学为什么要学-node-js" tabindex="-1"><a class="header-anchor" href="#后端同学为什么要学-node-js"><span>后端同学为什么要学 Node.js</span></a></h3>
<p>因为前端同学在学 Node.js。</p>
<h2 id="什么是-node-js" tabindex="-1"><a class="header-anchor" href="#什么是-node-js"><span>什么是 Node.js</span></a></h2>
<h3 id="官方定义" tabindex="-1"><a class="header-anchor" href="#官方定义"><span>官方定义</span></a></h3>
...
<h3 id="node-js-的组成" tabindex="-1"><a class="header-anchor" href="#node-js-的组成"><span>Node.js 的组成</span></a></h3>
...
<ul>
<li>
<p><strong>ECMAScript</strong>。ECMAScript 的所有语法在 Node 环境中都可以使用。</p>
</li>
<li>
<p><strong>Node 环境</strong>提供的一些<strong>附加 API</strong>(包括文件、网络等相关的 API)。</p>
</li>
</ul>
<p>如下图所示：</p>
<p><img src="http://img.smyhvae.com/20200409_1545.png" alt=""></p>
<h3 id="补充" tabindex="-1"><a class="header-anchor" href="#补充"><span>补充</span></a></h3>
<p>与 PHP、JSP、Python、Perl、Ruby 的“既是语言，也是平台”不同，Node.js 的使用 JavaScript 进行编程，运行在 Chrome 的 V8 引擎上。</p>
<p>与 PHP、JSP 等相比（PHP、JSP、.net 都需要运行在服务器程序上，Apache、Nginx、Tomcat、IIS。
），Node.js 跳过了 Apache、Nginx、IIS 等 HTTP 服务器，它自己不用建设在任何服务器软件之上。Node.js 的许多设计理念与经典架构（LAMP = Linux + Apache + MySQL + PHP）有着很大的不同，可以提供强大的伸缩能力。Node.js 没有 web 容器。</p>
...
<h2 id="node-js-的架构和依赖" tabindex="-1"><a class="header-anchor" href="#node-js-的架构和依赖"><span>Node.js 的架构和依赖</span></a></h2>
<p>Node.js 的架构如下：</p>
<p><img src="http://img.smyhvae.com/20180301_1540.png" alt=""></p>
...
<h3 id="node-js-运行环境的核心-v8-引擎-和-libuv-库" tabindex="-1"><a class="header-anchor" href="#node-js-运行环境的核心-v8-引擎-和-libuv-库"><span>Node.js 运行环境的核心：V8 引擎 和 libuv 库</span></a></h3>
<p>Node.js 是 JavaScript 在服务器端的运行环境，在这个意义上，Node.js 的地位其实就是 JavaScript 在服务器端的虚拟机，类似于 Java 语言中的 Java 虚拟机。</p>
<ul>
<li>
<p><a href="https://v8.dev/" target="_blank" rel="noopener noreferrer">V8 引擎</a> ：编译和执行 JS 代码、管理内存、垃圾回收。V8 给 JS 提供了运行环境，可以说是 JS 的虚拟机。V8 引擎本身是用 C++ 写的。</p>
</li>
<li>
<p><a href="https://zh.wikipedia.org/wiki/Libuv" target="_blank" rel="noopener noreferrer">libuv</a>： libuv 是一个专注于异步 I/O 的跨平台类库，目前主要在 Node.js 上使用。它是 Node.js 最初的作者 Ryan Dahl 为 Node.js 写的底层类库，也可以称之为虚拟机。libuv 本身是用 C 写的。</p>
</li>
</ul>
<h3 id="java-虚拟机和-v8-引擎-是由同一人开发" tabindex="-1"><a class="header-anchor" href="#java-虚拟机和-v8-引擎-是由同一人开发"><span>Java 虚拟机和 V8 引擎，是由同一人开发</span></a></h3>
<p>Chrome 浏览器成功的背后，离不开 JS 的 V8 引擎。作为虚拟机，V8 的性能表现优异，它的开发者是 Lars Bak。在 Lars 的工作履历里，绝大部分都是与虚拟机相关的工作。在开发 V8 之前，他曾经在 Sun 公司工作，担任 HotSpot 团队的技术领导，主要致力于开发高性能的 Java 虚拟机。在这之前，他也曾为 Self、Smalltalk 语言开发过高性能虚拟机。这些无与伦比的经历让 V8 一出世就超越了当时所有的 JS 虚拟机。</p>
<p><img src="http://img.smyhvae.com/20200617_1120.png" alt=""></p>
<p>V8 的性能优势使得用 JavaScript 写高性能后台服务程序成为可能。在这样的契机下，Ryan Dahl 选择了 JavaScript，选择了 V8，在事件驱动、非阻塞 I/O 模型的设计下实现了 Node。</p>
<h3 id="v8-的内存限制" tabindex="-1"><a class="header-anchor" href="#v8-的内存限制"><span>V8 的内存限制</span></a></h3>
<p>在一般的后端开发语言中，在基本的内存使用上没有什么限制，然而在 Node 中通过 JavaScript 使用内存时就会发现只能使用部分内存（64 位系统下约为 1.4GB，32 位系统下约为 0.7GB）。在这样的限制下，将会导致 Node 无法直接操作大内存对象。</p>
...
<h2 id="node-的发展历史" tabindex="-1"><a class="header-anchor" href="#node-的发展历史"><span>Node 的发展历史</span></a></h2>
<ul>
<li>
<p>2008 年左右，随着 Ajax 的逐渐普及，Web 开发逐渐走向复杂化，系统化；</p>
</li>
<li>
<p>Node.js 诞生于 2009 年，由 Joyent 的员工 Ryan Dahl 开发而成。2009 年 5 月，Ryan Dahl 在 GitHub 中开源了 Node 的最初版本，同年 11 月，在 JSConf 大会上展示了 Node 项目；</p>
</li>
<li>
<p>2010 年 1 月，NPM 包管理工具诞生，使得程序员能够更方便地发布和分享 Node.js 的第三方库。</p>
</li>
<li>
<p>Node.js 最初只支持 Linux 和 Mac OS 操作系统。2011 年 7 月，微软参与合作，Node.js 终于支持了 Windows 平台。PS：不过，node 的生产环境基本是在 Linux 下。</p>
</li>
<li>
<p>目前官网最新版本已经更新到 14.x.x 版本，最新稳定的是 12.18.0。</p>
</li>
</ul>
<p>据 Node.js 创始人 Ryan Dahl 回忆，他最初希望采用 Ruby，但是 Ruby 的虚拟机效率不行。</p>
<p>注意：是 Node 选择了 JavaScript，不是 JavaScript 发展出来了一个 Node。</p>
<h2 id="node-js-的应用" tabindex="-1"><a class="header-anchor" href="#node-js-的应用"><span>Node.js 的应用</span></a></h2>
...
<h3 id="_1、bff-中间层" tabindex="-1"><a class="header-anchor" href="#_1、bff-中间层"><span>1、BFF 中间层</span></a></h3>
...
<ul>
<li>
<p>对于前端来说：让前端<strong>有能力自由组装后台数据</strong>，这样可以减少大量的业务沟通成本，加快业务的迭代速度；并且，前端同学能够<strong>自主决定</strong>与后台的通讯方式。</p>
</li>
<li>
<p>对于后台和运维来说，好处是：安全性（不会把主服务器暴露在外面）、降低主服务器的复杂度等。</p>
</li>
</ul>
<h3 id="_2、服务端渲染" tabindex="-1"><a class="header-anchor" href="#_2、服务端渲染"><span>2、服务端渲染</span></a></h3>
...
<ul>
<li>
<p><a href="https://ssr.vuejs.org/zh/" target="_blank" rel="noopener noreferrer">Vue 服务端渲染的概念</a></p>
</li>
<li>
<p><a href="https://blog.csdn.net/u012036171/article/details/88833200" target="_blank" rel="noopener noreferrer">https://blog.csdn.net/u012036171/article/details/88833200</a></p>
</li>
<li>
<p><a href="https://juejin.im/post/5c068fd8f265da61524d2abc" target="_blank" rel="noopener noreferrer">https://juejin.im/post/5c068fd8f265da61524d2abc</a></p>
</li>
<li>
<p><a href="https://www.zhihu.com/question/59578433/answer/326694511" target="_blank" rel="noopener noreferrer">方应杭</a></p>
</li>
</ul>
<p>历史回顾：</p>
...
<h3 id="_3、做小型服务、小型网站的后端-基于-express、koa-框架" tabindex="-1"><a class="header-anchor" href="#_3、做小型服务、小型网站的后端-基于-express、koa-框架"><span>3、做小型服务、小型网站的后端（基于 Express、Koa 框架）</span></a></h3>
...
<h3 id="_4、做项目构建工具" tabindex="-1"><a class="header-anchor" href="#_4、做项目构建工具"><span>4、做项目构建工具</span></a></h3>
<p>前端正在广泛使用的构建工具 gulp、Webpack，就是基于 Node.js 来实现的。</p>
<h3 id="_5、-做-pc-客户端软件-基于-electron-框架" tabindex="-1"><a class="header-anchor" href="#_5、-做-pc-客户端软件-基于-electron-框架"><span>5、 做 PC 客户端软件（基于 Electron 框架）</span></a></h3>
...
<h3 id="知名度较高的-node-js-开源项目" tabindex="-1"><a class="header-anchor" href="#知名度较高的-node-js-开源项目"><span>知名度较高的 Node.js 开源项目</span></a></h3>
<p><img src="http://img.smyhvae.com/20180301_2009.png" alt=""></p>
<ul>
<li>
...
<h2 id="最后一段-前端同学会-node-js-就真的全栈了吗" tabindex="-1"><a class="header-anchor" href="#最后一段-前端同学会-node-js-就真的全栈了吗"><span>最后一段：前端同学会 Node.js 就真的全栈了吗？</span></a></h2>
<p>一个人的精力是有限的，既擅长前端、又精通后端的人，毕竟是极少数。</p>
