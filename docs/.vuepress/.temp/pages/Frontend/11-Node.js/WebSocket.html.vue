<template><div><h2 id="websocket-的引入" tabindex="-1"><a class="header-anchor" href="#websocket-的引入"><span>WebSocket 的引入</span></a></h2>
<h3 id="背景分析" tabindex="-1"><a class="header-anchor" href="#背景分析"><span>背景分析</span></a></h3>
...
<h3 id="http-长连接和-websocket-的长连接区别" tabindex="-1"><a class="header-anchor" href="#http-长连接和-websocket-的长连接区别"><span>http 长连接和 websocket 的长连接区别</span></a></h3>
...
<h3 id="socket-io-的引入" tabindex="-1"><a class="header-anchor" href="#socket-io-的引入"><span>Socket.IO 的引入</span></a></h3>
...
<h3 id="socket-io-的安装" tabindex="-1"><a class="header-anchor" href="#socket-io-的安装"><span>Socket.IO 的安装</span></a></h3>
<p>Socket.IO 的官网是：<a href="http://socket.io/" target="_blank" rel="noopener noreferrer">http://socket.io/</a></p>
<p>安装方式：</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">	npm install socket.io</span>
