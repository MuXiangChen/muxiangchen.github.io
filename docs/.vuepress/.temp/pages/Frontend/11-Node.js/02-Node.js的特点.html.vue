<template><div><h2 id="node-js-的特点" tabindex="-1"><a class="header-anchor" href="#node-js-的特点"><span>Node.js 的特点</span></a></h2>
<ul>
<li>
<p>异步、非阻塞 IO 模型</p>
</li>
...
<h2 id="使用-node-js-时的劣势" tabindex="-1"><a class="header-anchor" href="#使用-node-js-时的劣势"><span>使用 Node.js 时的劣势</span></a></h2>
<ul>
<li>
<p>程序运行不稳定，可能会出现服务不可用的情况</p>
</li>
<li>
<p>程序运行效率较低，每秒的请求数维持在一个较低的水平</p>
</li>
<li>
<p>前端同学对服务器端的技术不太熟悉。</p>
</li>
</ul>
</div></template>
