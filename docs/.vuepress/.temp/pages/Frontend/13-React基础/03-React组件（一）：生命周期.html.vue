<template><div><h2 id="组件的生命周期" tabindex="-1"><a class="header-anchor" href="#组件的生命周期"><span>组件的生命周期</span></a></h2>
<p>在组件创建、到加载到页面上运行、以及组件被销毁的过程中，总是伴随着各种各样的事件，这些在组件特定时期，触发的事件统称为组件的生命周期。</p>
<h2 id="生命周期的阶段" tabindex="-1"><a class="header-anchor" href="#生命周期的阶段"><span>生命周期的阶段</span></a></h2>
<p>组件生命周期分为三个阶段，下面分别来讲解。</p>
<h3 id="_1、组件创建阶段" tabindex="-1"><a class="header-anchor" href="#_1、组件创建阶段"><span>1、组件创建阶段</span></a></h3>
<blockquote>
...
<h3 id="_2、组件运行阶段" tabindex="-1"><a class="header-anchor" href="#_2、组件运行阶段"><span>2、组件运行阶段</span></a></h3>
<blockquote>
...
<h3 id="_3、组件销毁阶段" tabindex="-1"><a class="header-anchor" href="#_3、组件销毁阶段"><span>3、组件销毁阶段</span></a></h3>
<p>一辈子只执行一次。</p>
<ul>
...
<ul>
<li>
<p><a href="https://cn.vuejs.org/v2/guide/instance.html#%E7%94%9F%E5%91%BD%E5%91%A8%E6%9C%9F%E5%9B%BE%E7%A4%BA" target="_blank" rel="noopener noreferrer">vue中的生命周期图</a></p>
</li>
<li>
<p><a href="http://www.race604.com/react-native-component-lifecycle/" target="_blank" rel="noopener noreferrer">React Native 中组件的生命周期</a></p>
</li>
</ul>
<h2 id="组件生命周期的执行顺序" tabindex="-1"><a class="header-anchor" href="#组件生命周期的执行顺序"><span>组件生命周期的执行顺序</span></a></h2>
