...
<h2 id="什么是doctype及作用" tabindex="-1"><a class="header-anchor" href="#什么是doctype及作用"><span>什么是DOCTYPE及作用</span></a></h2>
...
<h3 id="常见的doctype声明有几种" tabindex="-1"><a class="header-anchor" href="#常见的doctype声明有几种"><span>常见的DOCTYPE声明有几种</span></a></h3>
<blockquote>
<p>面试官紧接着会问，常见的 DOCTYPE 有哪些，以及 HTML5 的 DOCTYPE 怎么写。</p>
</blockquote>
<p>1、<strong>HTML 4.01 Strict</strong>：（严格的）</p>
<div class="language-html line-numbers-mode" data-highlighter="prismjs" data-ext="html" data-title="html"><pre v-pre><code><span class="line"><span class="token doctype"><span class="token punctuation">&lt;!</span><span class="token doctype-tag">DOCTYPE</span> <span class="token name">HTML</span> <span class="token name">PUBLIC</span> <span class="token string">"-//W3C//DTD HTML 4.01//EN"</span> <span class="token string">"http://www.w3.org/TR/html4/strict.dtd"</span><span class="token punctuation">></span></span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>PS：该DTD包含所有的HTML元素和属性，但不包括展示性的和弃用的元素（比如 font、u下划线等，这些是被废弃了的）。</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div><p>PS：该DTD包含所有的HTML元素和属性，但包括展示性的和弃用的元素（比如 font、u下划线等）。</p>
<p>3、HTML 5：</p>
<div class="language-html line-numbers-mode" data-highlighter="prismjs" data-ext="html" data-title="html"><pre v-pre><code><span class="line"><span class="token doctype"><span class="token punctuation">&lt;!</span><span class="token doctype-tag">DOCTYPE</span> <span class="token name">html</span><span class="token punctuation">></span></span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p><strong>总结：</strong></p>
<p>面试时，不会让你写出 HTML 4.01的写法，因为大家都记不住。但是要记住 HTML 5 的写法，别看它简单，知道的人还真不多。</p>
<p>面试时，可以这样回答： HTML 4.01 中有两种写法，一种是严格的，一种是传统的；并且答出二者的区别。 HTML 5的写法是<code v-pre>&lt;!DOCTYPE html&gt;</code>。</p>
<h2 id="浏览器的渲染过程" tabindex="-1"><a class="header-anchor" href="#浏览器的渲染过程"><span>浏览器的渲染过程</span></a></h2>
<h3 id="渲染树" tabindex="-1"><a class="header-anchor" href="#渲染树"><span>渲染树</span></a></h3>
<p><img src="http://img.smyhvae.com/20210118-2005.png" alt=""></p>
<blockquote>
<p>上方图片的来源：<a href="https://developers.google.com/web/fundamentals/performance/critical-rendering-path/render-tree-construction?hl=zh-cn" target="_blank" rel="noopener noreferrer">Google 官方 | 渲染树构建、布局及绘制</a></p>
</blockquote>
...
<h3 id="渲染过程-重要" tabindex="-1"><a class="header-anchor" href="#渲染过程-重要"><span>渲染过程（重要）</span></a></h3>
<p>浏览器的渲染过程非常复杂，面试时找重点说就行，不然太耗时间。如何快速简洁地描述清楚，是关键。来看看下面这张图。</p>
<p><img src="https://img.smyhvae.com/20180310_1257.png" alt=""></p>
<p>渲染过程中，涉及到以下几个概念：</p>
<ul>
<li>
...
<p>参考链接：</p>
<ul>
<li><a href="http://www.cnblogs.com/slly/p/6640761.html" target="_blank" rel="noopener noreferrer">浏览器渲染原理及流程</a></li>
</ul>
<h3 id="关键渲染路径" tabindex="-1"><a class="header-anchor" href="#关键渲染路径"><span>关键渲染路径</span></a></h3>
...
<blockquote>
<p>上方图片的来源：<a href="https://developers.google.com/web/fundamentals/performance/rendering" target="_blank" rel="noopener noreferrer">https://developers.google.com/web/fundamentals/performance/rendering</a></p>
</blockquote>
...
<h2 id="布局-回流-重排" tabindex="-1"><a class="header-anchor" href="#布局-回流-重排"><span>布局/回流/重排</span></a></h2>
...
<p>我们还需要通过 <code v-pre>Layout</code> 布局阶段，来计算它们在设备视口(viewport)内的确切位置和大小，计算这些值的过程称为<code v-pre>回流</code>、<code v-pre>布局</code>或<code v-pre>重排（Reflow）</code>。</p>
<p>参考链接：</p>
<ul>
<li>
<p><a href="https://www.cnblogs.com/xiahj/p/11777786.html" target="_blank" rel="noopener noreferrer">从浏览器渲染原理，浅谈回流重绘与性能优化</a></p>
</li>
<li>
<p><a href="https://github.com/chenjigeng/blog/issues/4" target="_blank" rel="noopener noreferrer">你真的了解回流和重绘吗</a></p>
</li>
</ul>
<h3 id="什么时候会触发布局" tabindex="-1"><a class="header-anchor" href="#什么时候会触发布局"><span>什么时候会触发布局</span></a></h3>
...
<h2 id="绘制-重绘" tabindex="-1"><a class="header-anchor" href="#绘制-重绘"><span>绘制/重绘</span></a></h2>
<h3 id="定义-2" tabindex="-1"><a class="header-anchor" href="#定义-2"><span>定义</span></a></h3>
...
<h3 id="什么时候触发绘制" tabindex="-1"><a class="header-anchor" href="#什么时候触发绘制"><span>什么时候触发绘制</span></a></h3>
<ul>
<li>
<p>DOM改动</p>
</li>
...
<p>参考链接：<a href="http://blog.csdn.net/liaozhongping/article/details/47057889" target="_blank" rel="noopener noreferrer">如何减少浏览器repaint和reflow ?</a></p>
</div></template>
