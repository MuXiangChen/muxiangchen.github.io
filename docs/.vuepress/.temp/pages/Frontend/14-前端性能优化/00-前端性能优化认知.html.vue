<template><div><h2 id="前端性能优化认知" tabindex="-1"><a class="header-anchor" href="#前端性能优化认知"><span>前端性能优化认知</span></a></h2>
<h3 id="什么是前端性能优化" tabindex="-1"><a class="header-anchor" href="#什么是前端性能优化"><span>什么是前端性能优化</span></a></h3>
...
<p>上方图片的来源：</p>
<ul>
<li><a href="https://medium.com/dev-channel/the-cost-of-javascript-84009f51e99e" target="_blank" rel="noopener noreferrer">The Cost Of JavaScript</a></li>
<li><a href="https://github.com/dwqs/blog/issues/59" target="_blank" rel="noopener noreferrer">[译]JavaScript 的时间消耗</a></li>
</ul>
<h3 id="性能优化的重要性-程序员角度" tabindex="-1"><a class="header-anchor" href="#性能优化的重要性-程序员角度"><span>性能优化的重要性（程序员角度）</span></a></h3>
...
<h3 id="前端性能优化面试" tabindex="-1"><a class="header-anchor" href="#前端性能优化面试"><span>前端性能优化面试</span></a></h3>
...
<h3 id="性能优化的意义" tabindex="-1"><a class="header-anchor" href="#性能优化的意义"><span>性能优化的意义</span></a></h3>
...
<h3 id="相关案例" tabindex="-1"><a class="header-anchor" href="#相关案例"><span>相关案例</span></a></h3>
<ul>
<li>
<p><a href="https://www.gigaspaces.com/blog/amazon-found-every-100ms-of-latency-cost-them-1-in-sales/" target="_blank" rel="noopener noreferrer">Amazon发现每100ms延迟导致1%的销量损失</a>。</p>
</li>
<li>
...
<p>有些同学做事有拖延症，经常喜欢刷朋友圈、刷微博、看新闻，导致工作效率很低。为了解决这个问题，其实有个办法就是：把你的浏览器或者指定的软件，添加一个5秒的延迟，这时候，当你访问所有的网站，都会很慢。坚持一个月，你会发现，你再也不想看这些网站了，工作效率明显提升了许多。</p>
<p>这件事情从侧面也反映出：网站的性能如果不够好，对用户来说是一种折磨。时间一长，用户就不想用这个网站了。性能和网站的利益直接相关。涉及到：流量、搜索、转化率、用户体验。</p>
<h2 id="如何学习性能优化" tabindex="-1"><a class="header-anchor" href="#如何学习性能优化"><span>如何学习性能优化</span></a></h2>
<h3 id="学习难点" tabindex="-1"><a class="header-anchor" href="#学习难点"><span>学习难点</span></a></h3>
...
<h3 id="优化标准" tabindex="-1"><a class="header-anchor" href="#优化标准"><span>优化标准</span></a></h3>
...
<h3 id="技术储备前提" tabindex="-1"><a class="header-anchor" href="#技术储备前提"><span>技术储备前提</span></a></h3>
<ul>
<li>
<p>掌握前端基础知识。</p>
</li>
...
<h3 id="寻找性能瓶颈" tabindex="-1"><a class="header-anchor" href="#寻找性能瓶颈"><span>寻找性能瓶颈</span></a></h3>
<ul>
<li>
<p>了解性能指标，多快才算快。</p>
</li>
...
<h3 id="移动端挑战多" tabindex="-1"><a class="header-anchor" href="#移动端挑战多"><span>移动端挑战多</span></a></h3>
<ul>
<li>
...
<h3 id="收获" tabindex="-1"><a class="header-anchor" href="#收获"><span>收获</span></a></h3>
<ul>
<li>
<p>由浅入深：解读优化技术内幕。</p>
</li>
...
<h2 id="前端性能优化全过程" tabindex="-1"><a class="header-anchor" href="#前端性能优化全过程"><span>前端性能优化全过程</span></a></h2>
<h3 id="_1、静态资源优化" tabindex="-1"><a class="header-anchor" href="#_1、静态资源优化"><span>1、静态资源优化</span></a></h3>
...
<h3 id="_2、页面渲染架构设计及相关的技术方案选型" tabindex="-1"><a class="header-anchor" href="#_2、页面渲染架构设计及相关的技术方案选型"><span>2、页面渲染架构设计及相关的技术方案选型</span></a></h3>
<p>按照技术方案的分类，包括：</p>
<ul>
<li>
<p>前后端分离技术</p>
...
<h3 id="_3、原生app优化、混合开发优化" tabindex="-1"><a class="header-anchor" href="#_3、原生app优化、混合开发优化"><span>3、原生App优化、混合开发优化</span></a></h3>
<ul>
<li>
...
<h3 id="_4、服务端与网络优化" tabindex="-1"><a class="header-anchor" href="#_4、服务端与网络优化"><span>4、服务端与网络优化</span></a></h3>
<ul>
<li>
<p>CDN 和 DNS 优化</p>
</li>
...
<h3 id="_5、研发流程优化" tabindex="-1"><a class="header-anchor" href="#_5、研发流程优化"><span>5、研发流程优化</span></a></h3>
<ul>
<li>
<p>技术调用的方法</p>
</li>
...
<h3 id="_6、全链路质量监控体系建设" tabindex="-1"><a class="header-anchor" href="#_6、全链路质量监控体系建设"><span>6、全链路质量监控体系建设</span></a></h3>
...
<h2 id="前端性能优化包括哪些方面" tabindex="-1"><a class="header-anchor" href="#前端性能优化包括哪些方面"><span>前端性能优化包括哪些方面</span></a></h2>
<h3 id="_1、性能优化指标与测量工具" tabindex="-1"><a class="header-anchor" href="#_1、性能优化指标与测量工具"><span>1、性能优化指标与测量工具</span></a></h3>
<ul>
<li>
<p>行业标准</p>
</li>
...
<h3 id="_2、渲染优化" tabindex="-1"><a class="header-anchor" href="#_2、渲染优化"><span>2、渲染优化</span></a></h3>
<ul>
<li>
<p>现代浏览器的渲染原理</p>
</li>
...
<h3 id="_3、代码优化" tabindex="-1"><a class="header-anchor" href="#_3、代码优化"><span>3、代码优化</span></a></h3>
<ul>
<li>
...
<h3 id="_4、资源优化" tabindex="-1"><a class="header-anchor" href="#_4、资源优化"><span>4、资源优化</span></a></h3>
<ul>
<li>
<p>压缩合并</p>
</li>
...
<h3 id="_5、构建优化" tabindex="-1"><a class="header-anchor" href="#_5、构建优化"><span>5、构建优化</span></a></h3>
<ul>
<li>
<p>webpack 优化配置</p>
</li>
...
<h3 id="_6、传输和加载优化" tabindex="-1"><a class="header-anchor" href="#_6、传输和加载优化"><span>6、传输和加载优化</span></a></h3>
<ul>
<li>
<p>gZip</p>
</li>
...
<h3 id="_7、更多主流优化方案" tabindex="-1"><a class="header-anchor" href="#_7、更多主流优化方案"><span>7、更多主流优化方案</span></a></h3>
<ul>
<li>
<p>SVG 优化图标</p>
</li>
