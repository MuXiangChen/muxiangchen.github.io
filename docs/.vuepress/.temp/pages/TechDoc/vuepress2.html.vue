<template><div><h1 id="vue-press-2的坑和记录" tabindex="-1"><a class="header-anchor" href="#vue-press-2的坑和记录" aria-hidden="true">#</a> Vue Press 2的坑和记录</h1>
<p>使用github ci自动化部署,文档不知道在扯些什么东西，反正这么搞就对了</p>
<div class="language-yaml ext-yml line-numbers-mode"><pre v-pre class="language-yaml"><code><span class="token comment"># name 可以自定义</span>
