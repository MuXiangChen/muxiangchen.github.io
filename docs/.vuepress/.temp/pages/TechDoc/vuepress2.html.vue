<template><div><h1 id="vue-press-2的坑和记录" tabindex="-1"><a class="header-anchor" href="#vue-press-2的坑和记录"><span>Vue Press 2的坑和记录</span></a></h1>
<p>使用github action自动化部署（坑太多了实在是）</p>
<div class="language-yaml line-numbers-mode" data-highlighter="prismjs" data-ext="yml" data-title="yml"><pre v-pre><code><span class="line"><span class="token comment"># name 可以自定义</span></span>
